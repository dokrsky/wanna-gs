...
const sourcePaths = ["app", "lib", "data", "scripts", "quality", ".github", ".agents/skills/wanna-gs-preflight/scripts", "package.json", "package-lock.json", "tsconfig.json", "next.config.*", ".nvmrc", ".gitignore", "card.md", "docs/CORE_REQUIREMENTS.md", "docs/decisions", "docs/research", "docs/context/GATE-01.md", "docs/09-verification-and-evals.md", "docs/14-agent-development-loop.md"];
