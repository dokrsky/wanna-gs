...
assert.deepEqual([full.products.length, full.stores.length, full.conditions.length, full.actors.length], [242, 8, 484, 28]);
...
console.log(`PASS domain pure checker: ${cases} commands/rejections; real 242/8/484/28 DTOs; FIFO/pools, consent, budget, replay, permissions, failure recovery, exact deadlines. SQL/IDB/browser/live: NOT RUN.`);
